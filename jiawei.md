...
## May 15
| Dataset | Model   | Attack              | Epochs | Classes | Batch Size | Learning Rate | Method              | Stage         | Param1 | Param2 | Param3 | Param4 | Param5 | Param6 | Param7 | Accuracy1 | Accuracy2 | Accuracy3 | Accuracy4 | Metric1 | Metric2 | Metric3  | Param8 | Param9 | Metric4  | Removing Samples       |
|---------|---------|---------------------|--------|---------|------------|---------------|---------------------|---------------|--------|--------|--------|--------|--------|--------|--------|-----------|-----------|-----------|-----------|---------|---------|----------|---------|---------|----------|------------------------|
...
| CIFAR10 | resnet9 | interclasslabelswap | 2000   | 3       | 1000       | 0.025         | Naive               | pretrainmodel | Null   | Null   | Null   | Null   | Null   | Null   | Null   | 0.0       | 101.0     | 0.665     | 0.6805    | Null    | Null    | 0.89475  | 0       | 24.80638| 0.90056  | 0                      |
